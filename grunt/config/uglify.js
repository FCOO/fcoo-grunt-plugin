...
module.exports = function ( grunt ) {
    ...
    //Options for Uglify2
    var uglifyCompressOptions = common.readJSONFile('.uglifyrc');
    common.updateOptions( uglifyCompressOptions, {
        //Default options for Compression options for UglifyJS. Same as is .uglifyrc in fcoo/fcoo-gruntfile.js
    ...
    return {
        build: {
            options: {
                ...
                report          : 'gzip',                  //Choices: 'none', 'min', 'gzip'. Default: 'min'. Either report only minification result or report minification and gzip results. This is useful to see exactly how well UglifyJS is performing but using 'gzip' will make the task take 5-10x longer to complete. Example output. If 'none' is used the report will be generated on the verbose output.
                preserveComments: false,                   //Options: false 'all' 'some'
            },
